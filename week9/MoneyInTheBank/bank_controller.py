...
from transaction_controler import TransactionController
...
class BankController:
    ...
    def __init__(self, db_connection_string, block_after_n_logins=5, block_for_n_minutes=5):
        ...
        self.__auth = AuthenticatonController(
            self.__session, block_after_n_logins=block_after_n_logins, block_for_n_minutes=block_for_n_minutes)
